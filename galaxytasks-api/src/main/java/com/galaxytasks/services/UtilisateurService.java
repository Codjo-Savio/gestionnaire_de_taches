...
public class UtilisateurService {
    ...
    public void initSuperUtilisateurSiInexistant() {
        if (!utilisateurRepository.existsByEmail(adminProperties.getEmail())) {
            ...
            adminDto.setIdUtilisateur(null); // Let the database generate the ID
            adminDto.setNomUtilisateur("SuperUser");
            adminDto.setEmail(adminProperties.getEmail());
            adminDto.setMotDePasse(adminProperties.getPassword());
            adminDto.setStatut(Statut.SUPER_UTILISATEUR);
            creerUtilisateur(adminDto);
        }
    }
